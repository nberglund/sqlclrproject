...
namespace DM.Build.Yukon.DeployProperties {
  public partial class finddb : Form {
    ...
    /// </summary>
    void SetUpHelp() {
      ResourceManager rm = new ResourceManager("DM.Build.Yukon.DeployProperties.StringResources", typeof(finddb).Assembly);
      hlpProv.SetShowHelp(cboServers, true);
      hlpProv.SetHelpString(cboServers, rm.GetString("fndDb_Servers_Txt"));

      hlpProv.SetShowHelp(btnRefresh, true);
      hlpProv.SetHelpString(btnRefresh, rm.GetString("fndDb_Refresh_Txt"));

      hlpProv.SetShowHelp(cboDbs, true);
      hlpProv.SetHelpString(cboDbs, rm.GetString("fndDb_Dbs_Txt"));

      hlpProv.SetShowHelp(btnNew, true);
      hlpProv.SetHelpString(btnNew, rm.GetString("fndDb_NewDb_Txt"));

      hlpProv.SetShowHelp(btnTest, true);
      hlpProv.SetHelpString(btnTest, rm.GetString("fndDb_Test_Txt"));

      hlpProv.SetShowHelp(btnOK, true);
      hlpProv.SetHelpString(btnOK, rm.GetString("fndDb_OK_Txt"));

      hlpProv.SetShowHelp(btnCancel, true);
      hlpProv.SetHelpString(btnCancel, rm.GetString("fndDb_Cancel_Txt"));
